...
import zombieAtlas from '../../../assets/zombie/zombie_atlas.json';
import zombie from '../../../assets/zombie/zombie.png';
import zombieAnim from '../../../assets/zombie/zombie_anim.json';
...
export class Zombie extends Phaser.Physics.Matter.Sprite {
  ...
  static preload(scene) {
    ...
    scene.load.animation('zombie_anim', zombieAnim);
  }
