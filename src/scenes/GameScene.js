...
export class GameScene extends Phaser.Scene {
  ...
  newZombie(x, y) {
    this.zombie = new Zombie(
      { scene: this, x:  x , y: y, texture: 'zombie', frame: 'skeleton-idle_0' },
      this.player
    );
  ...
  create () {
    ...
    this.bulletGroup = new LaserGroup(this);
    ...
    this.physicsEvent.setCollide(this.zombies, this.bulletGroup);
  }

  shootLaser(pointer) {
    this.bulletGroup.fireLaser(this.player.x, this.player.y - 20, pointer.x, pointer.y);
  }
